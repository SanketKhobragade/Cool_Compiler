...
public class CoolParser extends Parser {
	...
	public static final int
		RULE_program = 0, RULE_class_list = 1, RULE_class_ = 2, RULE_classMEMBER = 3, 
		RULE_member = 4, RULE_attr = 5, RULE_method = 6, RULE_arg_list = 7, RULE_arg = 8, 
		RULE_expression_list = 9, RULE_block_expr_list = 10, RULE_branch_list = 11, 
		RULE_branch = 12, RULE_let_list = 13, RULE_expression = 14;
	public static final String[] ruleNames = {
		"program", "class_list", "class_", "classMEMBER", "member", "attr", "method", 
		"arg_list", "arg", "expression_list", "block_expr_list", "branch_list", 
		"branch", "let_list", "expression"
	};
	...
	*/
	...
	public final Class_Context class_() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				{
				setState(42);
				((Class_Context)_localctx).c = match(CLASS);
				setState(43);
				((Class_Context)_localctx).type = match(TYPEID);
				setState(44);
				match(LBRACE);
				setState(45);
				((Class_Context)_localctx).fl = ((Class_Context)_localctx).classMEMBER = classMEMBER();
				setState(46);
				match(RBRACE);

						((Class_Context)_localctx).value =  new AST.class_(((Class_Context)_localctx).type.getText(), filename, "Object", ((Class_Context)_localctx).classMEMBER.value, ((Class_Context)_localctx).c.getLine());
			...
			case 2:
				...
				match(RBRACE);
						...
						((Class_Context)_localctx).value =  new AST.class_(((Class_Context)_localctx).type.getText(), filename, ((Class_Context)_localctx).par.getText(), ((Class_Context)_localctx).classMEMBER.value, ((Class_Context)_localctx).c.getLine());
	...
	public static class ClassMEMBERContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CoolParserVisitor ) return ((CoolParserVisitor<? extends T>)visitor).visitClassMEMBER(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final ClassMEMBERContext classMEMBER() throws RecognitionException {
		...
		enterRule(_localctx, 6, RULE_classMEMBER);
				...
				((ClassMEMBERContext)_localctx).value =  new ArrayList<AST.feature>();
		...
		try {
			...
			while (_la==OBJECTID) {
				...
				{
				setState(60);
				((ClassMEMBERContext)_localctx).c = member();
				setState(61);
				match(SEMICOLON);
				_localctx.value.add(((ClassMEMBERContext)_localctx).c.value);
				}
				}
				setState(68);
				_errHandler.sync(this);
	...
	public static class MemberContext extends ParserRuleContext {
		...
		public MethodContext f;
		public AttrContext v;
	...
	public final MemberContext member() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				{
				setState(69);
				((MemberContext)_localctx).f = method();

						((MemberContext)_localctx).value =  ((MemberContext)_localctx).f.value;
			...
			case 2:
				...
				{
				setState(72);
				((MemberContext)_localctx).v = attr();

						((MemberContext)_localctx).value =  ((MemberContext)_localctx).v.value;
	...
	public final MethodContext method() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				match(LPAREN);
				setState(102);
				((MethodContext)_localctx).argl = arg_list();
				setState(103);
				match(RPAREN);
				setState(104);
				match(COLON);
				...
				match(RBRACE);
						...
						((MethodContext)_localctx).value =  new AST.method(((MethodContext)_localctx).id.getText(), ((MethodContext)_localctx).argl.value, ((MethodContext)_localctx).type.getText(), ((MethodContext)_localctx).expr.value, ((MethodContext)_localctx).id.getLine());
	...
	public final Arg_listContext arg_list() throws RecognitionException {
		...
		enterRule(_localctx, 14, RULE_arg_list);
				...
				((Arg_listContext)_localctx).value =  new ArrayList<AST.formal>();
		...
		try {
			...
			{
			setState(113);
			((Arg_listContext)_localctx).c = arg();
			_localctx.value.add(((Arg_listContext)_localctx).c.value);
			setState(121);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
				...
				match(COMMA);
				setState(116);
				((Arg_listContext)_localctx).y = arg();
				_localctx.value.add(((Arg_listContext)_localctx).y.value);
				}
				}
				setState(123);
				_errHandler.sync(this);
	...
	public static class ArgContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CoolParserVisitor ) return ((CoolParserVisitor<? extends T>)visitor).visitArg(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final ArgContext arg() throws RecognitionException {
		...
		try {
			...
			{
			setState(124);
			((ArgContext)_localctx).id = match(OBJECTID);
			setState(125);
			match(COLON);
			setState(126);
			((ArgContext)_localctx).type = match(TYPEID);

					((ArgContext)_localctx).value =  new AST.formal(((ArgContext)_localctx).id.getText(), ((ArgContext)_localctx).type.getText(), ((ArgContext)_localctx).id.getLine()) ;
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(178);
				((ExpressionContext)_localctx).c = match(TILDE);
				setState(179);
				((ExpressionContext)_localctx).e1 = expression(22);

							((ExpressionContext)_localctx).value =  new AST.comp(((ExpressionContext)_localctx).e1.value, ((ExpressionContext)_localctx).c.getLine());
			...
			case 2:
				{
				setState(182);
				((ExpressionContext)_localctx).c = match(ISVOID);
				setState(183);
				((ExpressionContext)_localctx).expr = expression(21);

							((ExpressionContext)_localctx).value =  new AST.isvoid(((ExpressionContext)_localctx).expr.value, ((ExpressionContext)_localctx).c.getLine());
			...
			case 3:
				{
				setState(186);
				((ExpressionContext)_localctx).c = match(NOT);
				setState(187);
				((ExpressionContext)_localctx).e1 = expression(13);

							((ExpressionContext)_localctx).value =  new AST.neg(((ExpressionContext)_localctx).e1.value, ((ExpressionContext)_localctx).c.getLine());
			...
			case 5:
				{
				setState(195);
				((ExpressionContext)_localctx).c = match(LET);
				setState(196);
				...
				((ExpressionContext)_localctx).e1 = expression(8);
						...
						for(int i = ((ExpressionContext)_localctx).ll.value.size() - 1; i >= 0; --i) 
						{
							...
							((ExpressionContext)_localctx).value =  new AST.let(this_attr.name, this_attr.typeid, this_attr.value, _localctx.value, ((ExpressionContext)_localctx).c.getLine());
						}
			...
			case 7:
				{
				setState(207);
				((ExpressionContext)_localctx).c = match(IF);
				setState(208);
				...
				match(FI);
							...
							((ExpressionContext)_localctx).value =  new AST.cond(((ExpressionContext)_localctx).predicate.value, ((ExpressionContext)_localctx).ifbody.value, ((ExpressionContext)_localctx).elsebody.value, ((ExpressionContext)_localctx).c.getLine());
			...
			case 8:
				{
				setState(216);
				((ExpressionContext)_localctx).c = match(WHILE);
				setState(217);
				((ExpressionContext)_localctx).predicate = expression(0);
				setState(218);
				match(LOOP);
				...
				match(POOL);
							...
							((ExpressionContext)_localctx).value =  new AST.loop(((ExpressionContext)_localctx).predicate.value, ((ExpressionContext)_localctx).body.value, ((ExpressionContext)_localctx).c.getLine());
			...
			case 9:
				{
				setState(223);
				((ExpressionContext)_localctx).c = match(LBRACE);
				setState(224);
				((ExpressionContext)_localctx).el = block_expr_list();
				setState(225);
				match(RBRACE);

							((ExpressionContext)_localctx).value =  new AST.block(((ExpressionContext)_localctx).el.value, ((ExpressionContext)_localctx).c.getLine());
			...
			case 10:
				{
				setState(228);
				((ExpressionContext)_localctx).c = match(CASE);
				setState(229);
				((ExpressionContext)_localctx).predicate = expression(0);
				setState(230);
				match(OF);
				...
				match(ESAC);
					// define
							((ExpressionContext)_localctx).value =  new AST.typcase(((ExpressionContext)_localctx).predicate.value, ((ExpressionContext)_localctx).bl.value, ((ExpressionContext)_localctx).c.getLine());
			...
			case 11:
				{
				setState(235);
				((ExpressionContext)_localctx).c = match(NEW);
				setState(236);
				((ExpressionContext)_localctx).type = match(TYPEID);

							((ExpressionContext)_localctx).value =  new AST.new_(((ExpressionContext)_localctx).type.getText(), ((ExpressionContext)_localctx).c.getLine());
			...
			case 12:
				{
				setState(238);
				((ExpressionContext)_localctx).c = match(LPAREN);
				setState(239);
